...
const RegisterAndLoginScreen = () => {
  ...
  // All Firebase authentication error codes. Returns a string message in portuguese.
  const verifyFirebaseAuthErrorCode = (FirebaseAuthErrorCode) => {
  ...
  // Sign In to User Account and error code checking
  const signIn = () => {
    auth()
      ...
      .catch(error => {
        Alert.alert(verifyFirebaseAuthErrorCode(error.code))
      });
  };

  // Create User Account and error code checking
  const createUser = () => {
    auth()
      .createUserWithEmailAndPassword(email, password)
      .then(userCredentials => {
        console.log('User account created!', userCredentials);
      })
      .catch(error => {
        Alert.alert(verifyFirebaseAuthErrorCode(error.code))
  ...
  return (
    <View style={styles.container}>
      <View style={styles.container}>
        <Text style={styles.label}>Firebase Register:</Text>
